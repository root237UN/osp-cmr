    ...
    public function run()
    {
        ...
        MenuVisite::create(
            [
                ...
                'libelle'=> "Structures d’aide à l’insertion professionnelle ",
            ...
            MenuVisite::create( [
                ...
                'description'=>"Consultez les filières d'enseignement  offertes par l’ensemble des écoles d’enseignements secondaire sur le territoire national. Accéder ainsi aux spécificités de chacune d’elle !",
                'description_full'=>""
            ]);
            MenuVisite::create(  [
                'titre'=> "Accueil",
                'libelle'=> "La meilleure plateforme d’aide à l’orientation",
                'description'=>"Une plateforme conçue pour pallier le déficit de conseillers d’orientation au sein de nos écoles d'enseignement secondaire . Elle a pour but d'améloirer la transition des jeunes apprenants de l'école primaire vers le collège/lycée ainsi que celle du 1er cycle vers 2nd cycle de l'école secondaire, Afin de renforcer la prise de décision stratégique pour l’accomplissement d’une carrière.",
                'description_full'=>""
            ]);
    }
}
