...
<section id="content-parcours">
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-center py-5">
            <h2 class="title-option title-1-1 text-dark">Optez pour un <span style="font-weight: bold;"> parcours académique ...</span></h2>
        </div>
        ...
        <div class="row d-flex justify-content-center" id="parcours">
            ...
            <div class="col-4">
                <a class="card card-cover card-parcours" href="{{ route('section',  ['code' => $parcours->libelle, 'id'=>$parcours->id]) }}">
                    @if($parcours->id % 2 == 0)
