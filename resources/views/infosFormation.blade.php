        ...
        <div class="container">
            <div class="row my-4 py-4">
                <div class="col-7 left-part">
                    ...
                    <p>Ces formations ont pour vocation d’assurer l’insertion professionnelle, la compétitivité et la transformation socioéconomique. Elles donnent acces a une panoplie de competences necessaire a </p>
                    <p>
                        <ul>
            ...
            <div class="row my-4 py-4">
                ...
                <div class="col-5 left-part" style="padding-left: 20px;">
                    ...
                    <p>la formation professionnelle et la formation par la voie de l’apprentissage constituent une bouée de sauvetage pour de nombreux laissés-pour-compte</p>
                    <p>
                        <ul>
