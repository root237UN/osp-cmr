                ...
                <div class="card my-2 mx-3 card-welcome">
                    <div class="card-body">
                        <div class="col-7">
                            ...
                            <p class="text-white welcome-text-description">Administrez et gérez les structures de formations ainsi que les structures d’aide à l’insertion professionnelle du système.</p>
                        </div>
                        <div class="col-5"></div>
                    </div>
