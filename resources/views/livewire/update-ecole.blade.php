    ...
    <!-- Modal -->
    <div wire:ignore.self class="modal fade" id="updateEcoleModal" tabindex="-1" aria-labelledby="updateEcoleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form class="form" wire:submit.prevent="update">
                    <input type="hidden" value="" name="id" wire:mode="ids" />
                    <div class="modal-header">
                        <h5 class="modal-title" id="updateEcoleModalLabel">Modifier Ecole</h5>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn  btn-form-app"><i class="fas fa-edit"></i>Modifier</button>
                    </div>
                </form>
            </div>
        </div>
