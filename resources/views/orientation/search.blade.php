                ...
                <div class='box-search-input col-md-10'>
                    <form class='form-search' method="GET" action="{{ url('search') }}">
                        ...
                        <div class='search-input-wrapper'>
                            ...
                            <input type="hidden" name='global-term' value='job' />
...
@section('content-body')
    <style>
        .text-result-search {
            font-size: 25px;
            font-family: 'MTNBrighterSans-Light', sans-serif;
        }
        .subtitle-text{
            line-height: 24px;
            font-size: 16px;
    ...
    <div class='container' style="min-height: 40ch">
        <div class='row'>
            <div class="text-result-search">Resultat de la recherche de : <span class="title-1-1">" {{$term}}"</span></div>
            <div class="subtitle-text">Affichage de 11 sur 100</div>
